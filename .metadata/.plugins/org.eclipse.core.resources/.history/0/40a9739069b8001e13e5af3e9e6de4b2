...
public class CommentController {
	...
	@GetMapping(value="/writer/{cvoWriter}/{cno}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> getWriter(@PathVariable("cvoWriter") String writer, @PathVariable("cno")long cno){
		String getWriter = csv.getWriter(cno);
		log.info("@@@@@@@@@@@@@@@@@@@@ getwriter >> "+getWriter);
		return new ResponseEntity<String>(getWriter, HttpStatus.OK);
	}
