...
<div class="container">
	...
	<div class="mb-3">
		...
		<div class="d-grid gap-2 d-md-flex justify-content-md-end">
			<a href="/board/list"><button class="btn btn-secondary me-md-2" type="button">cancle</button></a>
			<a href="/board/delete?bno=${bdto.bvo.bno }"><button class="btn btn-danger" type="button">delete</button></a>
			<button class="btn btn-primary me-md-2" type="submit" id="regBtn">modify</button>
		</div>
